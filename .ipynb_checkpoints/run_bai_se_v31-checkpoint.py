...
def run_trials(algo, n_trials, n_arms, mu_best, mu_sub, sigma, delta, max_iter):

    all_outputs = []
    all_stop_times = []
    for trial_idx in range(n_trials):
        output, stop_time = algo(n_arms, mu_best, mu_sub, sigma, delta, max_iter)
...
def main():
    ...
    for idx, algo_name in enumerate(algo_names):
        ...
        trials_outputs, trials_stop_times = \
            run_trials(se, n_trials, n_arms, mu_best, mu_sub, sigma, delta, max_iter)
